...
* `target_username` (string, optional): The focal `username` for the query. Provide this if the user refers to an account by name (e.g., "wross_10"). The tool resolves the username to an ID internally.
...
<FUNCTION_CALL>
{"function": "traverse_hierarchy", "arguments": {"target_username": "agent2", "direction": "children"}}
</FUNCTION_CALL>
